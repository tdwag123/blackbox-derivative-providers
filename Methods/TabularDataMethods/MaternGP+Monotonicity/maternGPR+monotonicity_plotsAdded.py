...
def main():
    ...
    # plots fitted model vs. training points
    plot_model(monotone_gp=monotone_gp, x_scaler=x_scaler, y_mean=y_mean,
               y_scale=y_scale, X_train_raw=X_train_raw, y_train_raw=y_train_raw,
               learn_neg_flux=learnNegFlux, n_plot=60)
    
    # plot T-slices of model
    plot_slices(monotone_gp=monotone_gp, x_scaler=x_scaler, y_mean=y_mean,
               y_scale=y_scale, X_train_raw=X_train_raw, y_train_raw=y_train_raw,
               learn_neg_flux=learnNegFlux)
    
    # plot fitted derivatives vs. true derivs
    fig, ax = plot_derivs(
