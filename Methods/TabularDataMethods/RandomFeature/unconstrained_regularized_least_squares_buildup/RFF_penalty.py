...
class PenalizedRFFModel():
    ...
    def __init__(self, n_components=400, gamma=0.1, random_state=None, alpha=1e-6):
        ...
        reg_model: learns q from phi(X)     https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Ridge.html
        """
